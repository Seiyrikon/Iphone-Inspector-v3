...
public class IccTextField extends JTextField{
    public IccTextField(IphoneLabelInformation iphoneLabel) {

        super(iphoneLabel.getIcc().isBlank() ? Constants.EMPTY_STRING.get() : iphoneLabel.getIcc());
