...
import components.labels.Size20x80BlackIconLabel;
import components.labels.Size20x80BlackTextLabel;
...
public class Size20x80BlackPanel extends JPanel {
    ...
    public Size20x80BlackPanel(PdfViewerFrame pdfViewer, IphoneLabelInformation informationLabel) {
    ...
    private void viewPdf() {
        ...
        // informationLabel.getImei2().equals("N/A")) {
        // zplLabel = "^XA\r\n" + //
        // "^MMT\r\n" + //
        // "^PW945\r\n" + //
        // "^LL1417\r\n" + //
        ...
        // "^FT44,1280^ADN,18,10^FH\\^FD(S) Serial No. " +
        // informationLabel.getSerialNo() + "^FS\r\n" + //
        // "^FT44,1333^ADN,18,10^FH\\^FDIMEI/MEID " + informationLabel.getImei() +
        // "^FS\r\n" + //
        // "^FT44,1154^ADN,18,10^FH\\^FD" + informationLabel.getModelRegion() + " " +
        // informationLabel.getProductType() + ", " + informationLabel.getProductColor()
        // + ", " + informationLabel.getStorageType() + "^FS\r\n" + //
        // "^FT44,1182^ADN,18,10^FH\\^FDOther items as marked thereon Model
        // A2482^FS\r\n" + //
        ...
        // "^FT44,1333^ADN,18,10^FH\\^FDIMEI/MEID " + informationLabel.getImei() +
        // "^FS\r\n" + //
        // "^FT581,1324^ADN,18,10^FH\\^FDIMEI2 " + informationLabel.getImei2() +
        // "^FS\r\n" + //
        // "^FT44,1154^ADN,18,10^FH\\^FD" + informationLabel.getModelRegion() + " " +
        // informationLabel.getProductType() + ", " + informationLabel.getProductColor()
        // + ", " + informationLabel.getStorageType() + "^FS\r\n" + //
